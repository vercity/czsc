...
events_monitor = [
    ...
    Event(name="九笔aAbBc式类一买", operate=Operate.LO, factors=[
        Factor(name="周线_类一买", signals_all=[Signal("周线_倒1笔_类买卖点_类一买_九笔aAbBc式_任意_0")]),
    ...
    Event(name="九笔GG三买", operate=Operate.LO, factors=[
        Factor(name="周线_类三买", signals_all=[Signal("周线_倒1笔_类买卖点_类三买_九笔GG三买_任意_0")]),
    ...
    Event(name="11笔GG三买", operate=Operate.LO, factors=[
        Factor(name="周线_类三买", signals_all=[Signal("周线_倒1笔_类买卖点_类三买_11笔GG三买_任意_0")]),
    ...
    Event(name="一买", operate=Operate.LO, factors=[
        Factor(name="周线_类一买", signals_all=[Signal("周线_倒1笔_类买卖点_类一买_任意_任意_0")]),
        Factor(name="周线_形一买", signals_all=[Signal("周线_倒1笔_基础形态_类一买_任意_任意_0")]),
    ...
    Event(name="二买", operate=Operate.LO, factors=[
        Factor(name="周线_类二买", signals_all=[Signal("周线_倒1笔_类买卖点_类二买_任意_任意_0")]),
        Factor(name="周线_形二买", signals_all=[Signal("周线_倒1笔_基础形态_类二买_任意_任意_0")]),
    ...
    Event(name="三买", operate=Operate.LO, factors=[
        Factor(name="周线_类三买", signals_all=[Signal("周线_倒1笔_类买卖点_类三买_任意_任意_0")]),
