...
# =======================================================================================================
# 基础参数配置
ct_path = "/Volumes/OuGuMore/Stock/sensors"
...
# all_securities_pd = get_all_securities(['etf'])
# all_securities_pd.to_csv('/Volumes/OuGuMore/Stock/allETF')
all_securities_pd = pd.read_csv('/Volumes/OuGuMore/Stock/sensors/allStockETF', index_col=0)
all_concepts_pd = pd.read_csv('/Volumes/OuGuMore/Stock/sensors/allConcepts', index_col=0)
...
def monitor(use_cache=True):
    ...
    # print(len(symbols))
    k = 1
    for s in all_securities_pd.index:
        print(k)
        k += 1
        print(s)
        try:
...
if __name__ == '__main__':
    ...
    # ss = get_all_securities(['etf', 'stock'])
    # ss.to_csv('/Volumes/OuGuMore/Stock/sensors/allStockETF')
    # run_monitor()

    # jqconcepts = get_concepts()
    # jqconcepts.to_csv('/Volumes/OuGuMore/Stock/sensors/allConcepts')
